...
public class JsonCollection extends EntityCollection {
	/**
	 ...
	 *            &nbsp;<small>(right bracket)</small>.
	 */
	public JsonCollection withValue(String value) {
		clear();
	 ...
	 *            A JSONTokener
	 */
	public JsonCollection withValue(Tokener x)  {
	 ...
	 *            A Collection.
	 */
	public JsonCollection withValue(Collection<?> collection) {
		if (collection != null) {
	 ...
	 *            of Elements.
	 */
	public JsonCollection withValue(BaseEntity... values) {
