...
public class GenericCreator implements SendableEntityCreator{
	...
	public GenericCreator withItem(Object value) {
		...
		if(this.clazz==null){
	        ...
	        for (Method method : methods)
	        {
	           ...
	           if (methodName.startsWith("get") && !badProperties.contains(methodName) && !"".equals(methodName.trim())){
	...
	public boolean setValue(Object entity, String attribute, Object value, String type) {
		...
		return setNewValue(entity, "with"+this.getMethodName(attribute), value);
	}
}
