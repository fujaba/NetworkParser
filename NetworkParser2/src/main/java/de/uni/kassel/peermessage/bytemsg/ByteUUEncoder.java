 ...
 * @see         UUDecoder
 */
	   public class ByteUUEncoder extends ByteCharakterEncoding {
	        ...
	        * </pre>
	        */
	       public ByteUUEncoder(String fname) {
	           bufferName = fname;
	           mode = 644;
	       }
	        ...
	        * </pre>
	        */
	       public ByteUUEncoder(String fname, int newMode) {
	           bufferName = fname;
	           mode = newMode;
	       }
