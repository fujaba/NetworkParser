...
final class FormatInformation {
   ...
   */
  private static final int[][] FORMAT_INFO_DECODE_LOOKUP = {{0x5412, 0x00}, {0x5125, 0x01}, {0x5E7C, 0x02},
   ...
   * @param maskedFormatInfo2 second copy of same info; both are checked at the same time to establish
   *        best match
   * @return information about the format it specifies, or <code>null</code> if doesn't seem to match
   *         any known pattern
   */
  static FormatInformation decodeFormatInformation(int maskedFormatInfo1, int maskedFormatInfo2) {
    ...
    /*
     * Should return null, but, some QR codes apparently do not mask this info. Try again by actually
     * masking the pattern first
     */
  ...
  private static FormatInformation doDecodeFormatInformation(int maskedFormatInfo1, int maskedFormatInfo2) {
    ...
    /*
     * Hamming distance of the 32 masked codes is 7, by construction, so <= 3 bits differing means we
     * found a match
     */
    if (bestDifference <= 3) {
