...
final class MatrixUtil {
	...
	static void embedBasicPatterns(Version version, ByteMatrix matrix) throws RuntimeException {
	...
	static void maybeEmbedVersionInfo(Version version, ByteMatrix matrix) throws RuntimeException {
	...
	static void embedDataBits(BitArray dataBits, int maskPattern, ByteMatrix matrix) throws RuntimeException {
		int bitIndex = 0;
		int direction = -1;
	...
	static void makeTypeInfoBits(ErrorCorrectionLevel ecLevel, int maskPattern, BitArray bits) throws RuntimeException {
	...
	static void makeVersionInfoBits(Version version, BitArray bits) throws RuntimeException {
	...
	private static void embedDarkDotAtLeftBottomCorner(ByteMatrix matrix) throws RuntimeException {
