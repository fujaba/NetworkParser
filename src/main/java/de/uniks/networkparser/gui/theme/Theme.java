...
public class Theme {
	 ...
	 * @param key
	 *            the keyword
	 * @return if the style related to the {@code key} not exist, the style of
	 *         'plain' will return.
	 */
	public Style getStyle(String key) {
		Style returnStyle = styles.get(key);
		return returnStyle != null ? returnStyle
				: getStyle(StyleConstants.STYLE_PLAIN);
	}
}
