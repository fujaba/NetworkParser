...
public class StringContainer implements CharSequence {
	 ...
	 *
	 * @return return {@code true} if {@link #length()} is {@code 0}, otherwise
	 *         {@code false}
	 *
	 * @since 1.6
	 */
	...
	/**
	 * @return The interal value Needed by {@code String} for the contentEquals
	 *         method.
	 */
	 ...
	 *         object; {@code false} otherwise. Note that the result will be
	 *         {@code true} if the argument is the empty string or is equal to this
	 *         {@code String} object as determined by the {@link #equals(Object)}
	 *         method.
	 */
	 ...
	 *         string; {@code false} otherwise. Note also that {@code true} will be
