	...
	public DialogPane(DialogBox owner, Object parent) {
		...
		if (owner!= null) {
			...
			if(owner.isModel() == false) {
				...
				JavaFXUtil.setStyle(opaqueLayer, false, "lightweight-dialog-background");
				JavaFXUtil.addChildren(pane, 0, opaqueLayer);
			}
			JavaFXUtil.addChildren(pane, -1, owner.getRoot());
		}
