...
//		model.generate("src");
	...
	public void createTables() {
		...
		Assert.assertEquals("INSERT INTO Student (_ID, university, firstName, lastName, credits) values('1.S3', '1.U1', 'Michael', 'Mustermann', '7')", list.get(3).toString());
		Assert.assertEquals("INSERT INTO Student (_ID, university, firstName, lastName, credits) values('1.S2', '1.U1', 'Max', 'Mustermann', '5')", list.get(4).toString());
		Assert.assertEquals("INSERT INTO University (_ID, name, students, rooms) values('1.U1', 'Uni', '{1.S2, 1.S3}', '{}')", list.get(5).toString());
	}
	...
	public void createTablesWithUpdates() {
		...
		Assert.assertEquals("jdbc:sqlite:build/sampleC.db", list.get(0).toString());
		Assert.assertEquals("UPDATE Student SET university='1.U1', firstName='Michael', lastName='Mustermann', credits='7' WHERE _ID='1.S3'", list.get(1).toString());
		Assert.assertEquals("UPDATE Student SET university='1.U1', firstName='Max', lastName='Mustermann', credits='5' WHERE _ID='1.S2'", list.get(2).toString());
		Assert.assertEquals("UPDATE University SET name='Uni', students='{1.S2, 1.S3}', rooms='{}' WHERE _ID='1.U1'", list.get(3).toString());
