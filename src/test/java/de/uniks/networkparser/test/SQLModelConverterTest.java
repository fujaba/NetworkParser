...
//		model.generate("src");
	...
	public void createTables() {
		...
		Assert.assertEquals("INSERT INTO Student (_ID, university, firstName, lastName, credits) values('S3', 'U1', 'Michael', 'Mustermann', '7')", list.get(3).toString());
		Assert.assertEquals("INSERT INTO Student (_ID, university, firstName, lastName, credits) values('S2', 'U1', 'Max', 'Mustermann', '5')", list.get(4).toString());
	...
	public void createTablesWithUpdates() {
		...
		Assert.assertEquals("jdbc:sqlite:build/sampleC.db", list.get(0).toString());
		Assert.assertEquals("UPDATE Student SET university='U1', firstName='Michael', lastName='Mustermann', credits='7' WHERE _ID='S3'", list.get(1).toString());
		Assert.assertEquals("UPDATE Student SET university='U1', firstName='Max', lastName='Mustermann', credits='5' WHERE _ID='S2'", list.get(2).toString());
